...
export function Sidebar() {
  ...
  return (
    <div className={cn(
      "flex flex-col border-r border-mist bg-surface h-full transition-all duration-300 relative z-20",
...
export function Header() {
  return (
    <header className="h-12 border-b border-mist bg-surface flex items-center justify-between px-4 z-10 sticky top-0">
      ...
      <div className="flex items-center gap-6">
        <div className="flex items-center gap-2 text-xs text-ink hidden md:flex cursor-pointer hover:bg-slate/5 p-1.5 rounded-md border border-transparent hover:border-mist transition-colors">
        ...
        <div className="h-5 w-px bg-mist hidden md:block"></div>
        ...
        <div className="flex items-center gap-1">
          ...
          <Button variant="ghost" className="flex items-center gap-2 pl-1.5 pr-2 h-8">
            <div className="w-6 h-6 rounded-full bg-marine text-white flex items-center justify-center">
